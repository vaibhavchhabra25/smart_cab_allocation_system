  ...
  return (
    <Card shadow="sm" p="lg" radius="md" withBorder style={{ maxWidth: 350, margin: '0' }}>
      <Group position="apart" mt="md" mb="xs">
        <Text>
          <b style={{ color: '#2596be' }}>Driver Name</b>: {item.name}{' '}
        </Text>
        <Text>
          <b style={{ color: '#2596be' }}>Driver Contact</b>: {item.contact}{' '}
        </Text>
      ...
      <List>
        ...
        <List.Item>
          <b style={{ color: '#2596be' }}>Estimated Time to Arrive</b>: {item.timeToArrive} minutes
        </List.Item>
        <List.Item>
          <b style={{ color: '#2596be' }}>Capacity</b>: {item.capacity}
        </List.Item>
      </List>
      <Button
        variant="light"
